package com.pintoads.mylibrary.custum;
...
import com.pintoads.mylibrary.R;
...
public class CustomVideoPlayer extends LinearLayout {
    ...
    private void resetVideoPlayer() {
        playVideo = false;
        playBackPosition = 0;
        //progressBar.setVisibility(GONE);//todo have NullPointerException
...
//                    play();
    ...
    private class VideoPlayerListener implements OnClickListener, SeekBar.OnSeekBarChangeListener, ExoPlayer.EventListener, VideoRendererEventListener, AudioRendererEventListener {
        ...
        public void onLoadingChanged(boolean isLoading) {
            Log.i("XXXXXXXX", "isLoading " + isLoading);
        }
        ...
        public void onPlayerStateChanged(boolean playWhenReady, int playbackState) {
            switch (playbackState) {
                case Player.STATE_IDLE:
                    Log.i("XXXXXXXX", "STATE_IDLE " + playWhenReady);
                    break;
                case Player.STATE_READY:
                    ...
                    /////
                    if (playWhenReady)
                        playbackListener.onStartPlaying();
                    Log.i("XXXXXXXX", "STATE_READY " + playWhenReady);
                    break;
                case Player.STATE_BUFFERING:
                    ...
                    Log.i("XXXXXXXX", "STATE_BUFFERING " + playWhenReady);
                    break;
                case Player.STATE_ENDED:
                    resetVideoPlayer();
                    Log.i("XXXXXXXX", "STATE_ENDED " + playWhenReady);
                    break;
            }
        }
